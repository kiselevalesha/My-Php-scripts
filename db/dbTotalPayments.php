<?
    ...
    include_once('../php-scripts/models/totalPayment.php');
    
    class DBTotalPayment extends DBBase {

        public function __construct($idDb)
        {
            //$this->DropTable("TotalPayments", $idDb);
            $this->Init("TotalPayments", $idDb);
        }

        public function New() {
            $obj = new TotalPayment();
