<?
    ...
    include_once('../php-scripts/models/vendor.php');
    require_once '../php-scripts/utils/getUrlFile.php';
    
    class DBVendor extends DBBase {

        public function __construct($idDb)
        {
            //$this->DropTable("Vendors", $idDb);
            $this->Init("Vendors", $idDb);
        }
        ...
        public function GetIdDefault() {
            ...
            if (empty($base->id)) {
                ...
                $base->strFirebase = $this->GetUidVendorFromFirebase();
                $base->isNew = 0;
        ...
        function GetUidVendorFromFirebase() {
            
            $host = 1;

            $response = getUrlFile("https://us-central1-onlinezapis-b03a2.cloudfunctions.net/AddVendor?host=".$host, null);
